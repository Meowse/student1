 ...
 * Part 13: Threading
 * 
 * Topic:  Running CalculatedValue method on two separate threads with
 *      two different arrays at the same time.  Using join to join multiple 
 *      threads to the main thread to stall it until both are done.
 ***************************************************************************/
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                bool callCompleteBool = JoinThread(threadId, secondaryThread1);
                if (callCompleteBool)
                {
                ...
                callCompleteBool = JoinThread(threadId, secondaryThread2);
                if (callCompleteBool)
                {
                    Console.WriteLine("\n{0}: The result from {1} is: {2}",
