/***************************************************************************
 * 
 * Part 6: AsyncDelegates
 * 
 * Topic:  Use a callback for asynchronous calls to capture and display the
 *                  return value:
 *  1.  using directive for System.Runtime.Remoting.Messaging.
 *  2.  Callback method that is implemented in the client class and yet
 *          executed on the asynchronous thread.  It must match the 
 *          signature of the AsyncCallback delegate.
 *  3.  Steps in the callback method for executing the EndInvoke method
 *          and retrieving the return value.
 *  4.  Steps for making the asynchronous call including the callback 
 *          delegate.
 ***************************************************************************/
        ...
        static void Main(string[] args)
        {
            try
            {
                ...
                IAsyncResult asynchStatus = method.BeginInvoke
                    (10.4, 7.451, callbackMethod, null);
