 ...
 * Part 12: Threading
 * 
 * Topic:  Joining secondary thread to main thread to stall main thread
 *          while secondary thread is completing execution.
 ***************************************************************************/
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                Console.WriteLine("\n{0}: Joining secondary thread {1}: {2}.",
                    threadId,
                    secondaryThread.ManagedThreadId,
                    secondaryThread.Name);

                if (!secondaryThread.Join(10000))
                {
                    Console.WriteLine
                        ("\n{0}: Thread {1}: {2} " +
