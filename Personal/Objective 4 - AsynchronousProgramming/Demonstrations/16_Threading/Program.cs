 ...
 * Part 16: Threading
 * 
 * Topic:  1.   Use "lock" blocks with a singleton object to control the serial
 *                  use of a common resource (Console window in this example)
 *                  by multiple threads to avoid collisions.
 *         2.   Show the CIL code that really uses the Monitor class with
 *                  Enter and Exit methods in try/finally blocks.
 ***************************************************************************/
