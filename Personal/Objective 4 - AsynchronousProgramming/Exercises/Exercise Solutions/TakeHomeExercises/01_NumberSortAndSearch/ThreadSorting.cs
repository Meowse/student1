...
namespace ThreadSorting
{
    ...
    internal class SortAndSearch
    {
        ...
        internal void SortingMethod()
        {
            ...
            _printSearchMutex.ReleaseMutex();
        }
    ...
    internal class ThreadClass
    {
        ...
        private SortAndSearch.SortType _sortType;
        ...
        static void Main()
        {
            ...
            try
            {
                ...
                if (size > 0)
                {
                    ...
                    ThreadClass isSortThread = new ThreadClass(size, num, SortAndSearch.SortType.InsertionSort);
                    ThreadStart isStartPoint = new ThreadStart (isSortThread.ThreadMethod);
                    Thread t1 = new Thread(isStartPoint);
                    ...
                    // TODO: Create the thread object and give it the delegate.
                    // TODO: Set the name property of the thread.
                    ThreadClass hsSortThread = new ThreadClass(size, num, SortAndSearch.SortType.HeapSort);
                    ThreadStart hsStartPoint = new ThreadStart (hsSortThread.ThreadMethod);
                    Thread t2 = new Thread(hsStartPoint);
