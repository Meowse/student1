/************************************************************************
 * 
 * DeserializeSingleObjects: Part 6
 * 
 * Core Topics:
 * 1. OpenRead method of the File class.
 * 2. Deserialize method of the FormatterBinary class for deserializing  
 *          Employee objects.
 **********************************************************************/
    ...
    internal class Employees
    {
        ...
        internal void SaveEmployees(DirectoryInfo employeeDirectory)
        {
            ...
            foreach (Employee emp in employees)
            {
                ...
                //      the block is done.
                using (employeeFile = 
                    new FileStream(employeeFullFileName,FileMode.Create, 
        ...
        internal void GetSavedEmployees(DirectoryInfo employeeDirectory)
        {
            ...
            {
                using (employeeFile = 
                    File.OpenRead(employeeFileInfo.FullName))
                {
                    AddEmployee((Employee)binFormat.Deserialize(employeeFile));
                }
            }
        }
