/************************************************************************
 * 
 * SerializeCollectionOfObjects: Part 5
 * 
 * Core Topics:
 * 1. Serialize method of the FormatterBinary class for serializing a 
...
namespace Serialization
{
    internal class Employees
    {
        ...
        internal void SaveEmployeeCollection(DirectoryInfo employeeDirectory)
        {
            ...
            //      the block is done.
             using (employeeCollectionFile = new FileStream(
                 employeesFullFileName, 
                 FileMode.Create, 
                 FileAccess.Write, 
                 FileShare.None))
             {
