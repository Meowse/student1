//TODO:  After completing the 2 TODOs below, run this project
//  two times:
//  1.  Run with current settings of 2000 milliseconds of sleep in the Add method and
//          both joins in the JoinThread method set at 7000 milliseconds.  These settings
//          should produce correct total values.
//  2.  Change the sleep setting in the Add method to 10000 milliseconds, the first join
//          in the JoinThread method to 2000 milliseconds and the second join to 1
//          millisecond.  These settings should cause both secondary threads to be
//          aborted giving total values of 0.  You may or may not see the message from
//          the second join in the JoinThread method.  It will depend on how quick your
//          computer aborts the thread.
using System;
...
namespace UsingThreads
{
    ...
    class Program
    {
        private static bool JoinThread(int mainThreadID, Thread secondaryThread)
        {
        ...
        static void Main()
        {
            ...
            // TODO: Join the first secondary thread to the primary thread using the
            //      JoinThread method.
            if (JoinThread(threadID, secondaryThread1)== true)
            {
            ...
            // TODO: Join the second secondary thread to the primary thread using the
            //      JoinThread method.
            if (JoinThread(threadID, secondaryThread2) == true)
            {
