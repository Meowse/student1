...
namespace EventsLab
{
    internal class LoginClass
    {
        ...
        private void RaisePasswordAttemptsExceededEvent()
        {
            ...
            if (OnPasswordAlert != null)
            {
                ...
                OnPasswordAlert(this, new EventArgs());
            }
        }
    }
    ...
    class Program
    {
        ...
        static void Main()
        {
            ...
            //      in this class.
            loginVerify.OnPasswordAlert += new LoginClass.PasswordAlertHandler(program.DisplayPasswordAlert);
        ...
        static void loginVerify_OnPasswordAlert(object sender, EventArgs e)
        {
