...
namespace UsingThreads
{
    class Calculator
    {
        ...
        //TODO:  Implement exception handling in the method below. Display
        //      the exception message in the catch block. 
        public void Add(object inputValue)
        {
            ...
            {
                Console.WriteLine(
                    "\n\tThread {0}: Exception has occurred on secondary thread. Message is: {1}",
        ...
        public void Add(int firstNumber, int secondNumber)
        {
            ...
            throw new ArgumentException(
                "Exception was raised on the secondary thread.");
