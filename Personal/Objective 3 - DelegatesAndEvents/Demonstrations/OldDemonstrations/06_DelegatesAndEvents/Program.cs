...
namespace SignalAndWarningSystem
{
    ...
    internal class HotWaterTransferSystem
    {
        ...
        // The event mapping it to the RaiseWarningHandler delegate.
        ...
        internal int AlertTransferStationFloor(object sender, EventArgs e)
        {
            Console.WriteLine
        ...
        internal int AlertControlRoom(object sender, EventArgs e)
        {
            Console.WriteLine
        ...
        internal int AlertManagement(object sender, EventArgs e)
        {
            Console.WriteLine
        ...
        internal void RaiseWarningEvent()
        {
            if (OnRaiseWarning != null)
            {
                ...
                // returning void.
                OnRaiseWarning(this, null);

                //foreach (RaiseWarningHandler r in OnRaiseWarning.GetInvocationList())
                //{
                //    int x = r.Invoke(this, null);
                //}
            }
        }
            ...
            while (!cr.ExitSystem)
            {
                ...
                if (!status)
                {
                    ...
                    if (!emergencyOccured)
                    {
                        ...
                        //cr.HWTSystem.OnRaiseWarning +=        
                        //        cr.HWTSystem.RaiseWarningHandler
                        //        (cr.HWTSystem.AlertTransferStationFloor);
