/************************************************************************
 * 
 * Delegates and Events: Part 4
 * 
 * Core Topics:
 * 1. Using multicast delegates to contain multiple method calls.
 **********************************************************************/
...
namespace SignalAndWarningSystem
{
    ...
    internal delegate void RaiseWarning();
    ...
    internal class HotWaterTransferSystem
    {
        ...
        internal void AlertTransferStationFloor()
        {
            Console.WriteLine
                ("*** FLOOR - The HWT System is malfunctioning!");
        }

        internal void AlertControlRoom()
        {
            Console.WriteLine
                ("*** CONTROL - The HWT System is malfunctioning!");
        }

        internal void AlertManagement()
        {
            Console.WriteLine
