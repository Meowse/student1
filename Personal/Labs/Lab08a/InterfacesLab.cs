...
namespace InterfacesLab
{
    ...
    internal interface IBookProperties
    {
        string Title { get; }
        decimal Price { get; }
        // TODO:  Add method:    string FooBar(string foo);
    }
    ...
    internal class Book : IBookProperties, IBookMethods
    {
        ...
        // Implement IBookProperties FooBar 


        // Implement IBookMethods FooBar 
    }
    ...
    internal class CollectionTester
    {
        ...
        static void Main()
        {
            ...
            // TODO:  Call IBookProperties FooBar

            // TODO:  Call IBookMethods FooBar
