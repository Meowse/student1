...
namespace UsingThreads
{
    ...
    internal class Program
    {
        ...
        // state.
        // TODO: 1. Note the AutoResetEvent declaration below and the
        //      name being used for the TODOs later on.
        ...
        public static void ThreadDoneCallback()
        {
            ...
            lock (SyncObject.Sync)
            {
                ...
                if (_secondaryThreadCount == 0)
                {
                    ...
                    // TODO: 2. Use the AutoResetEvent object to signal the primary 
                    //  thread to wake up.
